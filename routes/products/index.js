...
productsRouter.get("/all-products-inside-the-page",
    ...
    (req, res, next) => {
        ...
        validateIsExistValueForFieldsAndDataTypes([
            ...
            { fieldName: "S Size", fieldValue: sizes ? JSON.parse(sizes)?.s : undefined, dataTypes: ["string"], isRequiredValue: false },
            { fieldName: "M Size", fieldValue: sizes ? JSON.parse(sizes)?.m : undefined, dataTypes: ["string"], isRequiredValue: false },
            { fieldName: "L Size", fieldValue: sizes ? JSON.parse(sizes)?.l : undefined, dataTypes: ["string"], isRequiredValue: false },
            { fieldName: "XL Size", fieldValue: sizes ? JSON.parse(sizes)?.xl : undefined, dataTypes: ["string"], isRequiredValue: false },
