...
productsRouter.get("/all-products-inside-the-page",
    ...
    (req, res, next) => {
        ...
        validateIsExistValueForFieldsAndDataTypes([
            ...
            { fieldName: "Colors", fieldValue: colors ? JSON.parse(colors) : colors, dataTypes: ["array"], isRequiredValue: false },
            ...
            // { fieldName: "Sizes", fieldValue: sizes, dataTypes: ["object"], isRequiredValue: hasSizes ?? false },
            // { fieldName: "S Size", fieldValue: s, dataTypes: ["string"], isRequiredValue: false },
            // { fieldName: "M Size", fieldValue: sizes?.m, dataTypes: ["string"], isRequiredValue: false },
            // { fieldName: "L Size", fieldValue: sizes?.l, dataTypes: ["string"], isRequiredValue: false },
            // { fieldName: "XL Size", fieldValue: sizes?.xl, dataTypes: ["string"], isRequiredValue: false },
            // { fieldName: "XXL Size", fieldValue: sizes?.xxl, dataTypes: ["string"], isRequiredValue: false },
            // { fieldName: "XXXL Size", fieldValue: sizes?.xxxl, dataTypes: ["string"], isRequiredValue: false },
            // { fieldName: "4XL Size", fieldValue: sizes?.["4xl"], dataTypes: ["string"], isRequiredValue: false },
        ], res, next);
    },
